    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">WalletWise</span>
        </div>
        <Link
          to="/login"
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white p-6 rounded-xl shadow-lg transform hover:scale-105 transition-all border border-indigo-100 group">
            ...
            <h3 className="text-xl font-semibold mb-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">Smart Money Tracking</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg transform hover:scale-105 transition-all border border-indigo-100 group">
            ...
            <h3 className="text-xl font-semibold mb-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">Visual Analytics</h3>
            <p className="text-indigo-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg transform hover:scale-105 transition-all border border-indigo-100 group">
            ...
            <h3 className="text-xl font-semibold mb-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text">Smart Savings</h3>
            <p className="text-indigo-600">

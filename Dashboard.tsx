    ...
    <div className="min-h-screen bg-[#FFFAFA]">
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div 
            className="bg-gradient-to-br from-indigo-500 to-indigo-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all cursor-pointer text-white relative overflow-hidden"
          ...
          <div 
            className="bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all cursor-pointer text-white relative overflow-hidden"
          ...
          <div 
            className="bg-gradient-to-br from-rose-500 to-rose-600 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all cursor-pointer text-white relative overflow-hidden"
          ...
          >
            <div className="flex items-center space-x-4 mb-4 relative z-10">
              ...
              <div>
                <p className="text-white/80">Monthly Expenses</p>
